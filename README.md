...
### 统计分析（Tab 页切换）
- **总览 Tab**：累计加油量、总花费、平均油耗；近 12 月油耗趋势条形图；年度花费横向对比
- **年度对比 Tab**：各年汇总卡片（加油次数、总里程、加油量、花费、平均油耗、平均成本）；跨年同月油耗对比图（按月份分组，不同年份用不同颜色并排柱状条）；跨年同月花费对比图
- **月度明细 Tab**：顶部年份筛选条（FilterChip 可按年过滤），下方月度统计卡片列表
...
### 查看统计
- 点击首页右上角的 **ℹ** 图标进入统计页面
- **总览**：查看总体统计数据、油耗趋势图（近 12 月）、年度花费对比
- **年度对比**：查看各年汇总，支持多年同月油耗和花费的彩色柱状对比图
- **月度明细**：可按年份筛选，查看每月加油量、花费、油耗详情
